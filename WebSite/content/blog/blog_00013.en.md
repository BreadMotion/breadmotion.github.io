---
title: Improving UX by Modaling Product Details
date: 2025-11-27
category: Technical Note
description: I modalized the product work details so they can be viewed without page transitions. About HTML acquisition using DOMParser and pitfalls during implementation.
...
Until now, clicking a work from the "Product List" on this site would transition to a detail page (`portfolio/xxxx.html`).

However, people who come to see the product probably want to "**zap through various works**".
...
Product detail pages already exist as actual files like `portfolio/work_01.html`.
