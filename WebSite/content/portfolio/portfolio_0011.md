...
昨今海外の何人かの技術開発者が大量の数百万のオブジェクトに対して一つづつ攻撃やインタラクトが可能なゲームロジックを実装している様子がTLにて流れていることがあるので、そう言われてみればゲームで一フレームにオブジェクトの数が数百万表示されたり座標が変わったりするゲームって過去なかった気がする...？と思い立ったのが始まりです。
